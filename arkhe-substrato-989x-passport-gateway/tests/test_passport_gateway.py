...
def test_fair_score_empty():
    ...
    # default fields like license="CC-BY-4.0", data_format="json", ontology="schema.org" and version="1.0.0" automatically add 0.5 points. So with dpid="test" (+0.0625) and access_protocol="https" (+0.125), the default empty is 0.6875.
    assert score < 0.7  # Poucos campos preenchidos, basic defaults only
