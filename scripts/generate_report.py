...
def generate_report():
    ...
    text = [
        ...
        "• Invariância Geométrica: Detecção de consciência exógena independente de substrato.",
        "• Validação Terrestre: Programa de pesquisa em coerência neural para calibração do τ."
    ]
    for line in text:
        c.drawString(inch + 0.2*inch, y, line)
        y -= 0.2*inch
