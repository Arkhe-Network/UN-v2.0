...
if __name__ == "__main__":
    bridge = OracleAwsArkheBridge("oracle://...", "arkhe", "pass")
    bridge.store_knowledge(["The Cathedral is ready.", "Seshat seals the vectors."])
    print(bridge.generate_with_context("Who seals the vectors?"))
